...
switch ($f) {
    case 'search':
        ...
        $content = file_get_contents_curl("https://c.y.qq.com/soso/fcgi-bin/client_search_cp?ct=24&qqmusic_ver=1298&new_json=1&remoteplace=txt.yqq.song&searchid=0&t=0&aggr=1&cr=1&catZhida=1&lossless=0&flag_qc=0&p=1&&n=5&g_tk=5381&loginUin=0&hostUin=0&format=json&inCharset=utf8&outCharset=utf-8&notice=0&platform=yqq&needNewCode=0&w=$keyword");
        echo $content;
        break;
    ...
    case 'music':
        ...
        $lrc = file_get_contents_curl("https://c.y.qq.com/lyric/fcgi-bin/fcg_query_lyric_new.fcg?songmid=$mid&g_tk=5381","https://y.qq.com/portal/song/$mid.html");
        $lrc = substr($lrc, 18, -1);
